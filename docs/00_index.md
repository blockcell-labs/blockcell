...
> 面向普通开发者和入门开发者的 blockcell 深度解析，覆盖主线系列与最新专题指南（本页为索引）
...
- [20｜Provider Pool — 多模型高可用配置](./20_provider_pool.md)
- [21｜intentRouter 多 Profile 配置指南](./21_intent_router_profiles.md)
